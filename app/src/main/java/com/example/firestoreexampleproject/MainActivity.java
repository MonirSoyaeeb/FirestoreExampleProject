 ...
 */
    ...
    protected void onStart() {
        super.onStart();
        // We can use stop method to remove the start method at the appropriate moment
        /*
        For this first we have to create
        ListenerRegistration listenerRegistration;  as reference
